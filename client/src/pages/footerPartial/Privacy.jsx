...
export default function Privacy() {
  return (
    <div className="container py-5">
      ...
      {/* Reference link to Cartello (adapted from Amazon) */}
      ...
      <p>
        ...
        Privacy Notice describes how Cartello.com and its affiliates
        (collectively "Cartello") collect and process your personal information
        through Cartello products, services, stores, website and physical
        locations, devices and applications that reference this Privacy Notice
        (together "Cartello Services"). By using Cartello Services, you are
      ...
      <p>
        ...
        Consumer Health Data Privacy Disclosure for additional information about
        the processing of your personal data and your rights under applicable
      ...
      <ul>
        ...
        <li>
          ...
          store certain types of information about your use of Cartello Services,
          including information about your interaction with products, content,
          and services. Our physical stores may use cameras, sensors, and other
          technology.
        </li>
        <li>
          <strong>Information from Other Sources:</strong> We might receive
          information about you from other sources, such as updated delivery and
      ...
      <p>
        ...
        improve the products and services that we offer. These purposes include:
      </p>
      <ul>
      ...
      <p>
        ...
        and improve Cartello Services, we use cookies and other identifiers. For
        more information, please read our Cookies Notice.
      </p>
      ...
      <p>
        ...
        described in this Privacy Notice, including with subsidiaries, third
        parties involved in transactions, service providers, and for legal
        compliance.
      </p>
      ...
      <p>
        ...
        encryption protocols, follow PCI DSS when handling credit card data, and
        maintain safeguards for storage and disclosure. We also recommend using
        unique passwords and signing out after using shared computers.
      </p>
      ...
      <p>
        ...
        share your name or directly identifying information. You can adjust your
        advertising preferences in Your Ads Privacy Choices.
      </p>
      ...
      <p>
        ...
        subject to this Notice and our Conditions of Use. Our Privacy Notice may
        change over time, but we will not make material changes that reduce
        protections without customer consent.
      </p>
    </div>
  );
}
